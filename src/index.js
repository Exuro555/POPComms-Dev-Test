...
const App = () => {
    ...
    useEffect(() => {
        axios.get("https://randomuser.me/api/?results=50&nat=gb").then(response => {
    ...
    const filteredData = popAPI && popAPI.filter((person) => {
        ...
        if (fullName.toLowerCase().includes(searchInput.toLowerCase()) || person.location.city.toLowerCase().includes(searchInput.toLowerCase()) ){
            return person
        } 
    })
    ...
    return popAPI ? (
        <div  style={Styles.pageStyling}>
            ...
            <div style={Styles.headerContainer} >
                <svg style={{height: 40, color: "#ededed"}} aria-hidden="true" focusable="false" data-prefix="fas" data-icon="address-book" class="svg-inline--fa fa-address-book" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M384 0H96C60.65 0 32 28.65 32 64v384c0 35.35 28.65 64 64 64h288c35.35 0 64-28.65 64-64V64C448 28.65 419.3 0 384 0zM240 128c35.35 0 64 28.65 64 64s-28.65 64-64 64c-35.34 0-64-28.65-64-64S204.7 128 240 128zM336 384h-192C135.2 384 128 376.8 128 368C128 323.8 163.8 288 208 288h64c44.18 0 80 35.82 80 80C352 376.8 344.8 384 336 384zM496 64H480v96h16C504.8 160 512 152.8 512 144v-64C512 71.16 504.8 64 496 64zM496 192H480v96h16C504.8 288 512 280.8 512 272v-64C512 199.2 504.8 192 496 192zM496 320H480v96h16c8.836 0 16-7.164 16-16v-64C512 327.2 504.8 320 496 320z"></path></svg>   
                <h1 style={{
                    color: "#e7e7e7",
                    marginLeft: "20px",
            ...
            >
                {selectedPerson && <div >
                    <div style={Styles.contactImage}>
                        <img src={selectedPerson.picture.large} style={Styles.contactImage}/>
                    </div>
                    ...
                    <div style={Styles.personInfoContainer} >
                        ...
                        <h3 style={Styles.heading3}>{`${selectedPerson.location.street.number} ${selectedPerson.location.street.name}, 
